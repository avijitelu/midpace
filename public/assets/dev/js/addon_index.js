let regForm = (function(){
    return {
        regFormValidation: function() {
            let regForm = document.getElementById("js-form-reg");
            let submit = document.getElementById("reg-submit-btn");
            submit.addEventListener("click", (event) => {
                event.preventDefault();
                let fname = document.getElementById("js-reg-fname");
                let lname = document.getElementById("js-reg-lname");
                let mode = document.getElementById("js-reg-mode");
                let speciality = document.getElementById("js-reg-speciality");
                let email = document.getElementById("js-reg-email");
                let password = document.getElementById("js-reg-psw");
                let confPassword = document.getElementById("js-reg-confpsw");
                let error = false;
